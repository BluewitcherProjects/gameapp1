<x-guest-layout>
    <div x-data="loginForm()" class="w-full">
        ...
        <div class="mt-10 pt-6 border-t border-white/5 flex justify-center space-x-6">
            <a href="{{ App\Models\Setting::first()?->telegram ?? App\Models\Setting::first()?->whatsapp ?? 'https://t.me/TNL_LAB_WEBSITE_DEVELOPER' }}" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center group">
                <div

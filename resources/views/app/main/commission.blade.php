...
<head>
    ...
    <link href="{{asset('css/chunk-3855a36a.7c588efe.css')}}" rel="prefetch">
    <link href="{{asset('css/chunk-48c196fe.bdd4d2bc.css')}}" rel="prefetch">
    <link href="{{asset('css/chunk-638b246f.91aa3c18.css')}}" rel="prefetch">
    <link href="{{asset('css/chunk-9ef35f76.e05bc063.css')}}" rel="prefetch">
    <link href="{{asset('css/app.6aec9c38.css')}}" rel="preload" as="style">
    <link href="{{asset('css/chunk-vendors.f0bcea2c.css')}}" rel="preload" as="style">
    <link href="{{asset('css/chunk-vendors.f0bcea2c.css')}}" rel="stylesheet">
    <link href="{{asset('css/app.6aec9c38.css')}}" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{asset('css/chunk-472e1ad4.a0773f73.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/chunk-0f77857e.35713388.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/chunk-0e23d48e.455b9822.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/chunk-3c66013c.fd57c69c.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/chunk-ec5a7c7c.c3d303df.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/chunk-1a96c94b.62a681ba.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/chunk-43abd354.7242387e.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/chunk-188fc534.22ef4f73.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/chunk-2661127c.5254b1ce.css')}}">
</head>
                                    ...
                                    @foreach(\App\Models\UserLedger::where('user_id', auth()->id())->orderByDesc('id')->get() as $element)
                                        <li style="display: flex;justify-content: space-between;align-items: center;">
                                            <div>
                                                ...
                                                <p style="margin-top: 5px;color: #0fb40f9e;">{{$element->created_at}}</p>
                                            </div>
                                            <div>

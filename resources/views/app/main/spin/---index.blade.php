...
<head>
    ...
    <link rel="stylesheet" href="{{asset('spin.css')}}">
    <style>
        body{
            background: #00695c;
        }
    ...
    <style>
        ...
        .btn_group {
            ...
            left: 0;
            bottom: 0;
            border-top: 1px solid #0fb40f24;
            overflow: hidden;
        }
        .leftBtn {
            width: 50%;
            float: left;
            border-right: 1px solid #0fb40f21;
            height: 100%;
            text-align: center;
            padding-top: 7px;
        }
...
<body>
<div class="container text-center mb-5" style="background: url('{{asset('static/img/bj.d01189ac.png')}}');background-size: cover;background-position: center;">
    <div class="row">
        <div class="col-md-12 mt-2 py-3 pb-5">
            <div class="d-flex justify-content-between">
                <div>
                    <img onclick="window.location.href='{{route('dashboard')}}'" src="{{asset('left.png')}}" alt="">
                </div>
                <div style="font-size: 20px;color: #fff;font-family: Righteous, cursive;">Lucky Bonus</div>
                <div>
                    <img onclick="window.location.href='{{route('spin.history')}}'" src="{{asset('note.png')}}" alt="">
                </div>
            </div>
        </div>
    </div>
...
{{--            <button id="spin" class="spin-click-button">Check your luck</button>--}}
        ...
        <div class="col-md-12 text-center mb-4 mt-5">
            <div class="card">
                <div class="card-body">
                    <div><img style="width: 100%;margin-top: -70px;" src="{{asset('static/img/icon_zhongjiang@3x.png')}}" alt=""></div>
                    <div>

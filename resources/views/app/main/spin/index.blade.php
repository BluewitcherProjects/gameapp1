                    ...
                    <uni-view data-v-0066fdc4="" class="r_box" onclick="openPop()">
                        ...
                        <uni-view data-v-0066fdc4="" class="container">
                            <uni-image data-v-0066fdc4="">
                                <div style="background-image: url({{asset('static/login/logo.png')}}; background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;')}}"></div>
                                <img src="{{asset('static/login/logo.png')}}" draggable="false"></uni-image>
                            <uni-image data-v-0066fdc4="">
                                <div style="background-image: url({{asset('static/login/logo.png')}}; background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;')}}"></div>
                                <img src="{{asset('static/login/logo.png')}}" draggable="false"></uni-image>
                            <uni-image data-v-0066fdc4="">
                    ...
                    <uni-view data-v-b25ea0a8="" data-v-0066fdc4="" class="prompt-box" style="display: none;">
                        <uni-view data-v-b25ea0a8="" class="prompt">
                            ...
                            <uni-view data-v-b25ea0a8="" class="prompt-buttons">
                                <uni-button data-v-b25ea0a8="" class="prompt-cancle" style="color: #0fb40f;" onclick="closePop()">Cancel</uni-button>
                                <uni-button data-v-b25ea0a8="" class="prompt-confirm rrc" style="background: #0fb40f;" onclick="submitBonusConde()">Submit</uni-button>
                            </uni-view>
                        </uni-view>
                    </uni-view>

        ...
        <uni-page-head uni-page-head-type="default">
            <div class="uni-page-head" style="background-color: #F79700; color: rgb(255, 255, 255);">
                ...
                <div class="uni-page-head-bd">
                    <div class="uni-page-head__title" style="font-size: 16px; opacity: 1;"> Income information</div>
                </div>
                <div class="uni-page-head-ft"></div>
            </div>
            ...
            <uni-page-body>
                ...
                <uni-view data-v-52b6708e="" class="content">
                    <uni-view data-v-7cf13343="" data-v-52b6708e="">
                        ...
                        @if(\App\Models\UserLedger::where('user_id', auth()->id())->where('amount', '>', 0)->count() > 0)
                            <uni-view data-v-52b6708e="" class="msgbox">
                                @foreach(\App\Models\UserLedger::where('user_id', auth()->id())->where('amount', '>', 0)->orderByDesc('id')->get() as $element)
                                    <uni-view data-v-52b6708e="" class="item">
                                        <uni-view data-v-52b6708e="" class="item_t">
                                            <uni-view data-v-52b6708e="" class="title">
                                                <uni-view data-v-52b6708e="" class="title_2">{{strtoupper(str_replace('_', ' ', $element->reason))}}</uni-view>
                                            </uni-view>
                                            <uni-view data-v-52b6708e="" class="con">
                                                ...
                                                <uni-view data-v-52b6708e="" class="conitem">
                                                    <uni-view data-v-52b6708e="" class="lab">Date & Time</uni-view>
                                            ...
                                            <uni-view data-v-52b6708e="" class="types2">
                                                <uni-view data-v-52b6708e="" class="lab">State</uni-view>
                                                <uni-view data-v-52b6708e="" class="msg">
                                                    <uni-text data-v-52b6708e="" class="sh"><span style="text-transform: capitalize">Added</span>
                                                    </uni-text>
                                                </uni-view>
                                            </uni-view>
                                        </uni-view>

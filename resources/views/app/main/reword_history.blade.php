...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('CLREnergy/dist/css/791.be86190f.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('CLREnergy/dist/css/278.5b9352be.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('CLREnergy/dist/css/345.18397afb.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('CLREnergy/dist/css/335.0a1ca413.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('CLREnergy/dist/css/189.6fd946d4.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('CLREnergy/dist/css/764.7f62e783.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('CLREnergy/dist/css/4.dcbe59fd.css')}}">
    <meta name="viewport"

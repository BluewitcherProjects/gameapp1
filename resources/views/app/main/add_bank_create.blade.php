        ...
        <uni-page-head uni-page-head-type="default">
            <div class="uni-page-head" style="background-color: #0fb40f; color: rgb(255, 255, 255);">
                ...
                <div class="uni-page-head-bd">
                    <div class="uni-page-head__title" style="font-size: 16px; opacity: 1;"> Edit Bank Account
                    </div>
                </div>
                <div class="uni-page-head-ft"></div>
            </div>
                    ...
                    <uni-view data-v-e547158c="" class="card_box" style="display: none;">
                        <uni-view data-v-e547158c="" class="card">
                            <uni-image data-v-e547158c="" class="sim">
                                <div style="background-image: url({{asset('static/img/card.3f0e19d5.png')}}; background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;')}}"></div>
                                <img src="{{asset('static/img/card.3f0e19d5.png')}}" draggable="false"></uni-image>

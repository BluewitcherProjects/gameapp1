...
<head>
    ...
    <link rel="stylesheet" href="{{asset('static/index.97465e7b.css')}}">
                ...
                <uni-view data-v-2c9aa287="" class="content">
                    <uni-view data-v-373aa5ec="" data-v-2c9aa287="" class="tabbar pr">
                        <uni-view data-v-373aa5ec="" class="back-wrap">
                            <img onclick="window.location.href='{{route('task')}}'" src="{{asset('left.png')}}" alt="">
                        </uni-view>
                        <uni-text data-v-373aa5ec="" class="title" style="color: rgb(255, 255, 255);"><span>My Team Commission</span></uni-text>
                    ...
                    <uni-view data-v-2c9aa287="" class="record d-b-c">
                        <uni-image data-v-2c9aa287="">
                            <div style="background-image: url({{asset('static/img/coin.png')}}; background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;')}}"></div>
                            <img src="{{asset('static/img/coin.png')}}" draggable="false"></uni-image>
                        <uni-view data-v-2c9aa287="" class="flex-1">
                            <uni-view data-v-2c9aa287="" class="ui text-ellipsis">{{$element->perticulation}}</uni-view>
                            <uni-view data-v-2c9aa287="" class="d-b-c mt10">
                                <uni-text data-v-2c9aa287="" class="f24"><span>Time:{{$element->created_at}}</span>
                                </uni-text>

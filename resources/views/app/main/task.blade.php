...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('CLREnergy/dist/css/870.1e90e4e9.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('CLREnergy/dist/css/808.df13f558.css')}}">
    <meta name="viewport"
        ...
        <div class="taskbox" data-v-3345f269="">
            <div class="van-nav-bar van-hairline--bottom navboxi" data-v-3345f269="">
                <div class="van-nav-bar__content">
                    ...
                    <div class="rightimg" data-v-61186c26="" onclick="window.location.href='{{route('reword.history')}}'"><img style="width: 25px;margin-right: 12px;" src="{{asset('aaa.png')}}" alt="" data-v-61186c26=""></div>
                </div>
            </div>
            <img class="imgtaskio" src="{{asset('CLREnergy/dist/img/1.166a5a2a.png')}}" alt="" data-v-3345f269="">
            ...
            <section class="section-box" data-v-3345f269="">
                ...
                <div class="listinvite" data-v-3345f269=""><p class="rebatei" data-v-3345f269="">Interest commission rebate,
                    ...
                    <img class="imgtask firtsimgi" src="{{asset('CLREnergy/dist/img/5.8086695a.png')}}" alt="" data-v-3345f269="">
                ...
                <div class="listinvite" data-v-3345f269=""><p class="rebatei" data-v-3345f269="">Invite users to invest
                    ...
                    <img class="imgtask" src="{{asset('CLREnergy/dist/img/6.dd450411.png')}}" alt="" data-v-3345f269=""></div>
            </section><!----><!----></div>
    </div><!----></div>
@include('loading')

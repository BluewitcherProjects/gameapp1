        ...
        <uni-page-head uni-page-head-type="default">
            <div class="uni-page-head" style="background-color: #F79700; color: rgb(255, 255, 255);">
                <div class="uni-page-head-hd">
                    <div class="uni-page-head-btn" onclick="window.location.href='{{route('history')}}'"><i class="uni-btn-icon"
                                                                                                            style="color: rgb(255, 255, 255); font-size: 27px;"></i></div>
                    <div class="uni-page-head-ft"></div>
                </div>
                <div class="uni-page-head-bd">
                    <div class="uni-page-head__title" style="font-size: 16px; opacity: 1;"> Record</div>
                </div>
                <div class="uni-page-head-ft"></div>
            </div>
                                    ...
                                    <uni-view data-v-52b6708e="" class="item">
                                        <uni-view data-v-52b6708e="" class="item_t">
                                            <uni-view data-v-52b6708e="" class="title">
                                                <uni-view data-v-52b6708e="" class="title_2">{{ucfirst(str_replace('_', ' ', $element->reason))}}</uni-view>
                                            </uni-view>
                                            <uni-view data-v-52b6708e="" class="con">
                                                ...
                                                <uni-view data-v-52b6708e="" class="conitem">
                                                    <uni-view data-v-52b6708e="" class="lab">Received Date</uni-view>
                                            ...
                                            <uni-view data-v-52b6708e="" class="types2">
                                                <uni-view data-v-52b6708e="" class="lab">Received Status</uni-view>
                                                <uni-view data-v-52b6708e="" class="msg">
                                                    <uni-text data-v-52b6708e="" class="sh"><span>Received</span>
                                                    </uni-text>
                                                </uni-view>
                                            </uni-view>
                                        </uni-view>

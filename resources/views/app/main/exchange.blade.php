...
<head>
    ...
    <link rel="stylesheet" href="{{asset('cliem')}}/index.css">
    <style>
    *{
    ...
    <style type="text/css">
        ...
        .exchange .content-wrap[data-v-921f994c] {
            position: relative;
            height: 100%;
            background: url({{asset('cliem')}}/bg_exchange.png) top/cover no-repeat
        }
        ...
        .exchange .content-wrap .exchange-btn[data-v-921f994c] {
            ...
            width: 218px;
            height: 81px;
            background: url({{asset('cliem')}}/bg_exchange_btn.png) 50%/cover no-repeat;
            text-align: center;
            line-height: 58px;
            font-size: 18px;
            font-family: Microsoft YaHei, Arial, PingFang-SC-Bold, PingFang-SC, "sans-serif";
        ...
        .exchange .gift[data-v-921f994c] {
            ...
            background: url({{asset('cliem')}}/static/mine/bg_gift.png) 50%/cover no-repeat
        }
...
<div class="ex" style="display: none;">
    <img style="width: 100%;" src="{{asset('ex.png')}}" alt="">
                    ...
                    <uni-view data-v-decf012e="" data-v-921f994c="" class="nav-bar navigationbar uni-page-head flex-center-between">
                        <div data-v-decf012e="" class="left flex-center-center">
                            <uni-navigator data-v-decf012e="" class="back-btn" onclick="window.location.href='{{route('profile')}}'">
                                <img data-v-decf012e="" src="{{asset('cliem')}}/btn_navigationbar_back_light.png" class="icon">
                            </uni-navigator>
                        </div>

...
<script>
    ...
    function openMessage(type, message){
        ...
        document.querySelector('.message').style.transition = '.4s';
         ...
         if (type === 'success'){
             document.querySelector('.messageImg').innerHTML = `<img style="width: 100%;margin-top: 20px;" src="{{asset('check.png')}}" alt="">`;
         }
        if (type === 'error'){
            document.querySelector('.messageImg').innerHTML = `<img style="width: 100%;margin-top: 30px;filter: unset;width:30px !important;" src="{{asset('close.png')}}" alt="">`;
        }

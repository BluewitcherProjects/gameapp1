                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <fieldset class="form-group">
                                                    ...
                                                    <div class="custom-file">
                                                        ...
                                                        <div class="valid-feedback">
                                                            <i class="bx bx-radio-circle"></i> Note: Package image mandatory
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </div>
                                    ...
                                    <div class="col-sm-6">
                                        <label for="commission_with_avg_amount">Total Commision</label>
                                        <input type="number" class="form-control is-valid"
...
<div class="col-sm-6">
    ...
    <select name="presale" id="presale" class="form-control" required>
        <option value="">--Select Presale--</option>
        <option value="yes" {{ isset($data) && $data->presale == 'yes' ? 'selected' : '' }}>Yes</option>
        <option value="no" {{ isset($data) && $data->presale == 'no' ? 'selected' : '' }}>No</option>
    </select>
    <div class="valid-feedback">
        <i class="bx bx-radio-circle"></i> Note: This field is required
    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="number" class="form-control is-valid"
                                               ...
                                               placeholder="Buy Limit" min="1"
                                               value="{{$data ? $data->buy_limit : old('buy_limit')}}" required>
                                        <div class="valid-feedback">
                                            <i class="bx bx-radio-circle"></i> Note: This field is required
                                        </div>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title">
                                <div class="d-flex justify-content-between">
                                    <div style="margin-top: .7rem !important">Submit Your Package Information</div>
                                    <div>

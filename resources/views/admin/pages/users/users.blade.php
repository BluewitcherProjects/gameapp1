                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('admin.user.ban', $row->id)}}" class="btn btn-danger"
                                            ...
                                            @else
                                            <a href="{{route('admin.user.unban', $row->id)}}" class="btn btn-success"
                                                style="padding: 3px 7px;font-size: 20px" title='Account UnBan'>
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" class="btn btn-danger"
                                                ...
                                                data-target="#bonusModal{{$row->id}}" data-toggle="modal"
                                                title='Bonus Gift'>
                                                <i class="bx bx-gift"></i></a>

                                            <a href="{{route('admin.customer.login', $row->id)}}" target="_blank"
                                                class="btn btn-info" style="padding: 3px 7px;font-size: 20px"
                                                data-toggle="tooltip" title='Login Into User Account'>
                                                <i class="bx bx-user"></i></a>

                                            <a href="javascript:void(0)" class="btn btn-primary"
                                                data-target="#myModal{{$row->id}}"
                                                style="padding: 3px 7px;font-size: 20px" data-toggle="modal"
                                            ...
                                            <a href="{{route('admin.customer.status', $row->id)}}"
                                                ...
                                                title='@if($row->status == ' active') User status inactive after click
                                                @else User status active after click @endif'>
                                                <i
                                                    class="bx @if($row->status == 'active') bx-up-arrow @else bx-down-arrow @endif"></i></a>

                                            <a href="javascript:void(0)" class="btn btn-warning"
                                                style="padding: 3px 7px;font-size: 20px"
                                                data-target="#balanceModal{{$row->id}}" data-toggle="modal"
                                                title='Add Balance'>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="password" id="password"
                                                                ...
                                                                placeholder="Set User Password Again">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="bonus" id="bonus" required
                                                                class="form-control is-valid" placeholder="Bonus code">
                                                        </div>
                                                    </div>

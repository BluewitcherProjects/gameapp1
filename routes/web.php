...
// Bank setup routes
Route::get('add-bank', [BankController::class , 'card'])->name('user.bank');
Route::post('setup/gateway', [BankController::class , 'setupGateway'])->name('setup.gateway.submit');
...
Route::middleware('throttle:limit-check')->group(function () {
    Route::prefix('/admin')->group(function () {
            ...
            Route::post('income/add', [ManageUserController::class , 'add_income'])->name('admin.user.add_income');
            Route::post('income/minus', [ManageUserController::class , 'minus_income'])->name('admin.user.minus_income');
     ...
     */
        ...
        Route::middleware(['auth'])->group(function () {
            ...
            // Profile routes handled by UserController now
